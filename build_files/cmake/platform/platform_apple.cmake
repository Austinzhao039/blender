...
if(WITH_APPLE_CROSSPLATFORM)
  ...
  set(WITH_LIBMV OFF CACHE BOOL ${NO_PLATFORM_SUPPORT_MSG} FORCE)
  set(WITH_LIBMV_SCHUR_SPECIALIZATIONS OFF CACHE BOOL ${NO_PLATFORM_SUPPORT_MSG} FORCE)
  ...
  set(CMAKE_TOOLS_ARGS "${CMAKE_ARGS} -DWITH_CROSSCOMPILED_TOOLS=OFF -DAPPLE_TARGET_DEVICE=macos -DBLENDER_HOST_TOOLS_ONLY=ON ${CROSSCOMPILE_C_FLAGS} ${CROSSCOMPILE_CXX_FLAGS}")
  set(CMAKE_TOOLS_ARGS "${CMAKE_TOOLS_ARGS} -DWITH_ALEMBIC=OFF -DWITH_BULLET=OFF -DWITH_CODEC_FFMPEG=OFF -DWITH_CODEC_SNDFILE=OFF -DWITH_CYCLES=OFF -DWITH_CYCLES_DEVICE_METAL=OFF -DWITH_CYCLES_EMBREE=OFF -DWITH_CYCLES_PATH_GUIDING=OFF -DWITH_DRACO=OFF -DWITH_FFTW3=OFF -DWITH_FREESTYLE=OFF -DWITH_GMP=OFF -DWITH_HARU=OFF -DWITH_IK_ITASC=OFF -DWITH_IK_SOLVER=OFF -DWITH_IMAGE_CINEON=OFF -DWITH_IMAGE_OPENEXR=OFF -DWITH_IMAGE_OPENJPEG=OFF -DWITH_IMAGE_WEBP=OFF -DWITH_MANIFOLD=OFF -DWITH_MATERIALX=OFF -DWITH_MOD_FLUID=OFF -DWITH_MOD_OCEANSIM=OFF -DWITH_MOD_REMESH=OFF -DWITH_NANOVDB=OFF -DWITH_OPENAL=OFF -DWITH_OPENCOLORIO=OFF -DWITH_OPENIMAGEDENOISE=OFF -DWITH_OPENSUBDIV=OFF -DWITH_OPENVDB=OFF -DWITH_POTRACE=OFF -DWITH_PUGIXML=OFF -DWITH_PYTHON=OFF -DWITH_QUADRIFLOW=OFF -DWITH_TBB=OFF -DWITH_USD=OFF -DWITH_COMPILER_PRECOMPILED_HEADERS=OFF -DWITH_OPTIMIZED_BUILD_TOOLS=OFF")
